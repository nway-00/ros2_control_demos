...
def generate_launch_description():
    ...
    robot_description_content = Command(
        [
            ...
            PathJoinSubstitution(
                [FindPackageShare("diffbot_description"), "urdf", "originbot_system.urdf.xacro"]
            ),
        ]
    )
    ...
    diffbot_diff_drive_controller = PathJoinSubstitution(
        [
            ...
            "config",
            "originbot_diff_drive_controller.yaml",
        ]
    )
    ...
    # 生成节点： origin_base_controller
    spawn_dd_controller = Node(
        package="controller_manager",
        executable="spawner.py",
        arguments=["origin_base_controller"],
        output="screen",
    )
    # 生成节点： joint_state_broadcaster
